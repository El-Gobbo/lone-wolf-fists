...
There are two ways to get started: using the lwf system generator command or manually renaming and updating files.
...
Head over to the [Vue3lwf System](https://gitlab.com/asacolips-projects/foundry-mods/vue3lone-wolf-fists) repo if you're interested in using Vue!
